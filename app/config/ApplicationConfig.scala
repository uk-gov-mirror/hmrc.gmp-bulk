...
trait ApplicationConfig {
  ...
  val logIncompleteParentsEnabled: Boolean
}
...
class ApplicationConfiguration@Inject()(configuration: Configuration) extends ApplicationConfig {
  ...
  override val logIncompleteParentsEnabled: Boolean = configuration.getOptional[Boolean]("log-incomplete-parents-enabled").getOrElse(false)
}
